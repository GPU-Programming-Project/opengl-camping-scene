...
private:
    ...
    Mesh processMesh(aiMesh* mesh, const aiScene* scene, glm::mat4 nodeTransform, const std::string& nodeName)
    {
        ...
        glm::vec3 origin = glm::vec3(nodeTransform[3]);
        return Mesh(vertices, indices, textures, baseColor, nodeName, origin);
    }
